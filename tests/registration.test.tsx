...
import RegistrationChoice from "../src/components/content/registration";
...
describe("registration", () => {
  it("has not opened for anyone", () => {
    ...
    const { getByText } = render(<RegistrationChoice />);

    expect(
      getByText("Registration for participants has not opened yet", {
        exact: false,
      })
    ).toBeInTheDocument();
  ...
  it("is open for everyone", () => {
    ...
    expect(
      getByText("Registration for participants is open", {
        exact: false,
      })
    ).toBeInTheDocument();
  ...
  it("has closed for students and is open for volunteers", () => {
    ...
    expect(
      getByText("Registration for participants has closed", {
        exact: false,
      })
    ).toBeInTheDocument();
